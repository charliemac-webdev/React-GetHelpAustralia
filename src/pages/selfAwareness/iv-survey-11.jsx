  ...
  return (
    <>
      ...
      <MainContent>
        ...
        <hr />
        <h5 className="secondary-color">Question 9 of 11 - Spirituality</h5>
        <p>
          Try to focus on what spirituality means to you. This might be as
          simple as communing with nature, or as formal as participating in an
        ...
        <hr />
        <Link to="/internet-and-values-12">
...
export default InternetValuesEleven;
