...
const UnderstandingWhyModule = ({ showMenu }) => {
      ...
      try {
        const response = await fetch("/", {
          ...
          body: new URLSearchParams({
            "form-name": "understanding-why-reflection-form",
  ...
  const handlePostSubmit = () => {
    ...
    navigate("/triggers"); // Replace with the correct path to the next module
  };

  const processedModules = understandingWhyModuleData.map((module) => {
    ...
    <>
      ...
      <MainContent>
        ...
        <Module
          ...
          formName="understanding-why-reflection-form"
