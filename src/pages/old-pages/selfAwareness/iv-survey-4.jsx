    ...
    <>
      ...
      <MainContent>
        ...
        <h5 className="secondary-color">
          Question 2 of 11 - Sexual Relationships
        </h5>
        <p>
          What would you like your partner to say about you, long-term, given
          the person you would like to be in your sexual relationship?
        </p>
        <p className="mb-5">
          <b>
...
export default InternetValuesFour;
