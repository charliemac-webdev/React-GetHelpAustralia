    ...
    description: (
      <div className="tab-main-content">
        ...
        <p>
          ...
          to the world and how valuable we think we are to other people.
        </p>
        <p>
    ...
    description: (
      <div className="tab-main-content">
        ...
        <p>
          <strong>Diet</strong>
          <br />
          Eating a well-balanced diet at regular meal-times with plenty of water
          and vegetables will help you to feel healthier and happier. Stopping
          or reducing your alcohol intake, and avoiding tobacco and recreational
        ...
        <p>
          ...
          interview, you can use it to remind yourself of the good things about
          yourself.
        </p>
        <p>
          If you struggle to come up with a list of good things, you could ask
          your partner or a trusted friend to help you begin. This may also help
          you to see how others may have a higher opinion of you than you do.
        </p>
        <p>
          ...
          about themselves e.g. cards and letters which they can keep in a ‘feel
          good box.’
        </p>
        <p>
          <strong>Try mindfulness techniques</strong>
          <br />
          Mindfulness is a way of paying attention to the present moment, using
          techniques like meditation, breathing and yoga. It has been shown to
      ...
      <div className="tab-main-content">
        ...
        <ul className="content-list">
          ...
          <li>
            ...
            even realise they have upset you or done anything wrong, so what you
  ...
  },
  {
    ...
    description: (
      <div className="tab-main-content">
        ...
        <p>
          Self-praise is an important part of improving your self-esteem, while
          it may feel uncomfortable at first, it gets easier and really helps to
          build towards a better more positive future. Don’t forget to give
          yourself praise every time you achieve one of the above.
        </p>
        <p>
          It can be difficult for people to express their feelings assertively.
          ...
          blaming the other person. For example if you said to someone ‘you make
          me feel lonely’ versus ‘I feel lonely’. It can be helpful to have a
          structure to how you share difficult feelings.
        </p>
        <p>
          Here is an example:
          <br />
          ...
          <br />
          <strong>SPECIFY WHAT YOU WANT TO HAPPEN</strong> – “I would like us to
          have at least one evening a week together”
          <br />
