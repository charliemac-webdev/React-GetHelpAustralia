    ...
    description: (
      <div className="tab-main-content">
        ...
        <p>
          ...
          a&nbsp;sense of control&nbsp;over a situation by letting them rehearse
          how they will deal with a situation.
        </p>
        <p>
          For other people, it might be a way to release stress (escapism) or a
          way to experience things&nbsp;that they wouldn’t in everyday life
          (that lottery win).
        </p>
        <p>
        ...
        <p>
          ...
          outlet,&nbsp;often if they are not meeting their sexual needs within a
          relationship.
        </p>
        <p>A fantasy can have:</p>
        <ul className="content-list">
          <li>
            positive outcomes:&nbsp;for example imagining achieving an award or
        ...
        <p>
          Sometimes a person’s thoughts stray and it takes them a short time to
    ...
    description: (
      <div className="tab-main-content">
        ...
        <p>
          ...
          fantasises about something at one point or another.
        </p>
        ...
        <p>
          If you can identify with the bullet points above, then your fantasies
        ...
        <p>
          ...
          you had a fantasy, the type of fantasy (sexual or non-sexual) and your
          mood after the fantasy.
        </p>
        ...
        <p>
          But sexual fantasies themselves are not necessarily a bad thing – it’s
          what happens in that fantasy or who is in that fantasy that might need
          to be addressed.
        </p>
        <p>
    ...
    description: (
      <div className="tab-main-content">
        ...
        <p>
          ...
          person to have sexual fantasies about a 18 year old, than a 60 year
          old person.
        </p>
    ...
    description: (
      <div class="tab-main-content">
        ...
        <p>
          ...
          and it gives you the chance to explore what you like, what you don’t
          like and the type of person you want to see engaging in sexual
          activity.
        </p>
        <p>
          Over time, what you view will start to create and develop your sexual
          preferences and sexual fantasies.
        </p>
        <p>
        ...
        <p>
          ...
          this is going to develop your sexual preferences, just as adult
        ...
        <p>
          14. What would your close friends and family feel about this fantasy?
    ...
    description: (
      <div class="tab-main-content">
        ...
        <p>
          ...
          The more you use these, the more you will learn what works more
          effectively for you. It may be that you need to rehearse them or use a
        ...
        <p>
          ...
          go away. This happens with all urges, not just sexual urges; for
          example if you are craving chocolate, eventually this craving will go
        ...
        <p>
          Rather than try and change your sexual interest, your task is to learn
          how best to manage your sexual thoughts, feelings and fantasies. Of
          course there are no easy answers but the aim is to try and reduce both
        ...
        <ul className="content-list">
          <li>
            ...
            if you are not attracted to adults. To help, try focusing your
            attention exclusively on the physical sensations you experience
            while masturbating. Experiment with different sensations e.g. use of
            lubricants.
          </li>
          <li>
            <strong>Reduce the amount of time</strong>&nbsp;spent thinking or
            fantasising about children in a sexual way. The more time you spend
            having sexual fantasies about children, the more these thoughts will
            govern your mental and sexual life. So, the less time you spend
            thinking about children in a sexual way, the better.
          </li>
          <li>
            <strong>Develop a busy day-to-day lifestyle</strong>&nbsp;with a
            range of activities and interests that hold your attention. The more
            our minds are focused on things that we find engaging and rewarding,
            the less time we spend thinking about sexual things. This helps
            people feel more in control of their sexual thinking. And, of
            course, it helps people feel better about their lives more
            generally.
          </li>
          <li>
          ...
          <li>
            ...
            yourself, you are less likely to use sexual fantasies as a prop for
            your emotional health. Mindfulness is a technique that has been
            shown to improve people’s mental health and resilience.
          </li>
          <li>
