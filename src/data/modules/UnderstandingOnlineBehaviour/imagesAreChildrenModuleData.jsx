    ...
    description: (
      <>
        <div className="tab-main-content">
          ...
          <p>
            Justification describes how, when we encounter a situation in which
            our behaviour is inconsistent with our own or others’ beliefs and
            values, our minds tend to come up with false reasons for why our
            behaviour is okay. These reasons are called ‘justifications’, and
            they serve to make us feel more comfortable and give us permission
            to keep engaging in the behaviour.
          </p>
          <p>
            At first you might be aware that you are using justifications to let
            yourself look at illegal images. But your awareness of these
            justifications might fade over time the more they are used. Becoming
            aware of when we are making these justifications is the first step
      ...
      <>
        <div className="tab-main-content">
          ...
          <p>
            ...
            experience further harm by images of their abuse being out there,
            shared and viewed, all beyond their control.
          </p>
          <br></br>
          <h4 className="secondary-color">
          ...
          <p>
            ...
            to remember that any sexual image of a child is illegal.
          </p>
          <p>
          ...
          <p>
            ...
            is that this behaviour may act as a ‘slippery slope’. These sorts of
            images might act to reinforce sexual interest in children and lead
            the person viewing the images to become curious about what other
            sorts of material might be available. When children are depicted in
            images either on their own or with other children, where no adult is
            ...
            purpose. This is exploitation because a child cannot consent.
          </p>
          <p>
            Regarding victim-taken sexual images of children, it is important to
            remember that even though the child may have agreed to taking the
...

  {
    ...
    description: (
      <div>
        ...
        <ul className="content-list">
          <li>
            Images feature real children who cannot consent to sexual activity.
          </li>
